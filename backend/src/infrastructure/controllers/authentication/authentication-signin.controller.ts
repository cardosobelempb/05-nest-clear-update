...
import { WrongCredentialsError } from '@/infrastructure/erros/wrong-credentials-error'
...
export class AuthenticationSigninController {
  constructor(
    private readonly authenticationSigninUsecase: AuthenticationSigninUseCase,
  ) {}
