import { NotificationReadService } from '@/application/use-cases/notification/notification-read.service'
...
export class NotificationReadController {
  constructor(private readNotification: NotificationReadService) {}
